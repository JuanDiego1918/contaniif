...
public class PrimerFragment extends Fragment {
    ...
    public void showPopup3() {
        myDialogempezarPreuntas.setContentView(R.layout.popup_empezar_pregunta);
        btnEmpexarPreguntas = myDialogempezarPreuntas.findViewById(R.id.btnEmpezarPregunta);
        btnCancelarPreguntas = myDialogempezarPreuntas.findViewById(R.id.btnCancelarPregunta);

        btnCancelarPreguntas.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btnEmpexarPreguntas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myDialogempezarPreuntas.dismiss();
